...
theme: /
    ...
    state: Start
        q!: $regexp</start>
        q!: (* ~Запустить * * | * ~Активировать * * | * ~Открыть * * | * Запусти * * | * Активируй * * | * Открой * *) (*знаток* | *Знаток* | Знаток Online |  Знаток Онлайн | знаток онлайн | викторину знаток онлайн | викторина знаток онлайн | *викторин* | *вопрос*)
    ...
    state: ReadQuestion
        q!: (*прочитай* | *прочитайте* | *озвуч* | *прочитать* | *повтори* | *повтори вопрос* | *повторить вопрос*)
